...
model_name = 'electrophySpectralPower_phy';
...
if numel(incompleteExams) > 0
    ...
    for subj = 1 : length(modelDir)
        ...
        matlabbatch{subj}.spm.stats.fmri_spec.sess(1).multi_reg = gfile( dfonc{subj}{1} , '^multiple_regressors' , 1 );
        ...
        matlabbatch{subj}.spm.stats.fmri_spec.sess(2).multi_reg = gfile( dfonc{subj}{2} , '^multiple_regressors' , 1 );
