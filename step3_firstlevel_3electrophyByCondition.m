...
model_name = 'electrophyByConditon';
...
if numel(incompleteExams) > 0
    ...
    regressorFiles = get_subdir_regex_files(regressorDir, 'R_ByCondition_\d.mat$');
    ...
    NOTHING_Belt      = [ 0 0 0 0    0 0 0 0 ];
    
    Belt_NULL         = [ 1 0 0 0    0 0 0 0 ];
    Belt_Eye          = [ 0 1 0 0    0 0 0 0 ];
    Belt_Resp         = [ 0 0 1 0    0 0 0 0 ];
    Belt_Force        = [ 0 0 0 1    0 0 0 0 ];
    
    Belt_Diff_NULL    = [ 0 0 0 0    1 0 0 0 ];
    Belt_Diff_Eye     = [ 0 0 0 0    0 1 0 0 ];
    Belt_Diff_Resp    = [ 0 0 0 0    0 0 1 0 ];
    Belt_Diff_Force   = [ 0 0 0 0    0 0 0 1 ];
    
    
    NOTHING_Grip      = [ NOTHING_Belt          0 0 ];
    
    Grip_Force        = [ NOTHING_Belt          1 0 ];
    Grip_Diff_Force   = [ NOTHING_Belt          0 1 ];
