...
modeldir = 'ANOVA_factorial3_electrophyByCondition';
...
for s = 1 : size(myScans,1)
    ...
    current_contrastfile_BeltResp  = get_subdir_regex_files(current_imagepath,'con_0003.nii');
    current_contrastfile_BeltForce = get_subdir_regex_files(current_imagepath,'con_0004.nii');
